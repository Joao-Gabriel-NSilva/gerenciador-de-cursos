...
public class TestaCursoComAluno {
	...
	public static void main(String[] args) {
		...
		// o trecho acima é a forma antiga(antes do java 1.5) de iterar por um set, hoje equivale a:
		// javaColecoes.getAlunos().forEach(aluno -> {System.out.println(aluno);}); <- introduzida no java 1.8
